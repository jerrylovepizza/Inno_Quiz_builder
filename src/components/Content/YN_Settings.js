...
class YN_Settings extends Component {
    constructor(props) {
        super(props);
        ...
        <Fragment>
            <div class="q-s-option">
                ...
                <div class="q-s-checkbox">
                    <input type="checkbox" class="ios8-switch ios8-switch-sm" checked={question.required} onChange={(e) => {this.changeRequiredAnswer()}} id="ck-yn-2"/>
                    <label for="ck-yn-2"></label>
                </div>
            </div>
            ...
            <div class="q-s-option">
                ...
                <div class="q-s-checkbox">
                    <input type="checkbox" class="ios8-switch ios8-switch-sm" checked={question.add_img} onChange={(e) => {this.addImage()}} id="ck-yn-13"/>
                    <label for="ck-yn-13"></label>
                </div>
            </div>
            {
            question.add_img && 

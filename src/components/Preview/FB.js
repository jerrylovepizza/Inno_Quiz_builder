            ...
            <div class={q.img_align + " mc-question fb-question"}  >
                ...
                { q.social && 
                    <div class="qs-social-section">
                        <a class="qs-social twitter"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
